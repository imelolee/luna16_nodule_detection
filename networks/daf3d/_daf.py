...
class Daf3dResNet(ResNet):
    ...
    def __init__(
        ...
        self.conv1 = conv_type(
            n_input_channels, self.in_planes, kernel_size=7, stride=(2, 2, 2), padding=(3, 3, 3), bias=False
        )
...
class DAF3D(nn.Module):
    ...
    def forward(self, x):
        ...
        # layers from 1 - 4
        single_layer_features = list(self.backbone_with_fpn(x_pre).values())
