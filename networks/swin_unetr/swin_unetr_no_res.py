...
class SwinUNETR(nn.Module):
    ...
    def forward(self, x_in):
        ...
        dec3 = self.decoder4(hidden_states_out[4], hidden_states_out[3]) # 384, 1/32
        dec2 = self.decoder3(dec3, hidden_states_out[2]) # 192, 1/16
        dec1 = self.decoder2(dec2, hidden_states_out[1]) # 96, 1/8
        dec0 = self.decoder1(dec1, hidden_states_out[0]) # 48, 1/4
